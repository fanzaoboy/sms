		...
		<div class="account-pages">
			<div class="wrapper-page">
				<div class="text-center">
	                <a href="index.html" class="logo"><span>fanzao<span>boy</span></span></a>
	            </div>
	                ...
	                <div class="panel-body">
	                	<form class="am-form" method="post" action="">
	                		<div class="am-g">
		                        ...
		                        <div class="am-form-group ">
		                        	<button type="submit" class="am-btn am-btn-primary am-radius" style="width: 100%;height: 100%;" name="login" value="登录" formaction="login.do">Log In</button>
		                        </div>
